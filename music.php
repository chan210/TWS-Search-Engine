...
<link href='http://fonts.googleapis.com/css?family=Signika:400,700' rel='stylesheet' type='text/css'>
 ...
 <!-- Wrap all page content here -->
    ...
    <!-- Include all compiled plugins (below), or include individual music as needed -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li><a href="adminpanel\music\user_insert_music.php"><button type="button" class="btn btn-danger btn-lg">Upload a file!!!</button></a></li>
...
<a href="index.php"><img src="images/musicsearch.png"></a></div></br>
...
$sql ="SELECT * FROM music where f_tags='".$name."' or f_tags LIKE '".$name.",%' or f_tags LIKE '%, ".$name.",%' or  f_tags LIKE '%, ".$name."'";
...
$rs=$conn->query($sql);
	...
	else
	{
		...
		while($arr=$rs->fetch_array(MYSQLI_ASSOC))
		{
			echo "<tbody>";
			echo "<tr>";
			echo "<td>" . $arr['f_name'] . "</td>";
			echo "<td>" . $arr['file_name'] . "</td>";
			echo '<td> <a href="adminpanel/music/'.$arr['file_path'] .'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click Here To Download</a></td>';
			echo "</tr>";
			echo "</tbody>";
		}
	}
