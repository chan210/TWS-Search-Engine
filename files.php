 ...
 <!-- Wrap all page content here -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	  ...
	  <li><a href="adminpanel\files\user_insert_files.php"><button type="button" class="btn btn-danger btn-lg">Upload a file!!!</button></a></li>
...
<a href="index.php"><img src="images/filesearch.png"></a></div></br>
...
$sql ="SELECT * FROM files where f_tags='".$name."' or f_tags LIKE '".$name.",%' or f_tags LIKE '%, ".$name.",%' or  f_tags LIKE '%, ".$name."'";
...
$rs=$conn->query($sql);
	...
	else
	{
		...
		while($arr=$rs->fetch_array(MYSQLI_ASSOC))
		{
			...
			echo '<td> <a href="adminpanel/files/'.$arr['file_path'] .'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click Here To Download</a></td>';
			echo "</tr>";
			echo "</tbody>";
		}
	}
